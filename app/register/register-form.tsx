...
export default function RegisterForm({ locale, dictionary }: { locale: Locale; dictionary: Dictionary }) {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-md flex-col justify-center px-6 py-12">
      <div className="flex items-center justify-between gap-4"><h1 className="text-2xl font-semibold">{dictionary.register.title}</h1><LanguageSwitcher locale={locale} languageLabel={dictionary.common.language} compact /></div>
