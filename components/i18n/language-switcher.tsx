...
export function LanguageSwitcher({ locale, languageLabel, compact = false }: { locale: Locale; languageLabel: string; compact?: boolean }) {
  ...
  return (
    <div className={`inline-flex items-center rounded-full border border-[var(--nia-border)] bg-[var(--nia-surface-soft)] p-1 text-xs font-bold tracking-[0.1em] text-[var(--nia-text-muted)] ${compact ? "" : ""}`} aria-label={languageLabel}>
